...
def main():
    output_timestamp = utc_now_compact()
    ap = argparse.ArgumentParser(description=__doc__, formatter_class=argparse.RawDescriptionHelpFormatter)
    ap.add_argument("scan_json", help="output file from scan_api.py")
    ap.add_argument("--csv", default=f"toolkit/output/aggregate_results/out_{output_timestamp}.csv",
                    help="write per-repo counts to this CSV path (default: timestamped file in toolkit/output/aggregate_results)")
